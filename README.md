...
| Наименование проекта | Описание проекта  |Стек |
|:------------- |:---------------| :-------------:|
| Секреты темнолесья| Анализ влияния характеристик игроков и их персонажей на покупки внутриигровой валюты и игровую активность для оптимизации монетизации| SQL (DBeaver)|
